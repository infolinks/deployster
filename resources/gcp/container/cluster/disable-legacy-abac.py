...
def main():
    argparser = argparse.ArgumentParser(description='Disable legacy ABAC authorization.')
    ...
    op = get_container().projects().zones().clusters().legacyAbac(projectId=args.project_id,
                                                                  zone=args.zone,
                                                                  clusterId=args.name,
                                                                  body={
                                                                      'enabled': False
