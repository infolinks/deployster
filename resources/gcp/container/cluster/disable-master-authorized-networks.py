...
def main():
    argparser = argparse.ArgumentParser(description='Disable master authorized networks.')
    ...
    op = get_container().projects().zones().clusters().update(projectId=args.project_id,
                                                              zone=args.zone,
                                                              clusterId=args.name,
                                                              body={
                                                                  'update': {
